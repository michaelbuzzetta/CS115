...
class Test(unittest.TestCase):
    ...
    def test03(self):
        ...
        self.assertEqual(str(hc), 'Toyota Prius, MPG: 48, tank capacity: 9.1, 
battery kWh: 4.4, miles/kWh: 25.8')
    def test04(self):
        ...
        self.assertEqual(str(hc), 'Toyota Prius, MPG: 51.2, tank capacity: 7.8, 
battery kWh: 4.4, miles/kWh: 25.8')
